...
* [remkop/picocli](https://github.com/remkop/picocli) - Command line parser library and framework to easily build CLI applications in Java, Groovy, Kotlin, Scala,... GraalVM native image support. Usage help with ANSI colors. Autocomplete. Nested subcommands.  Easy to include as source to avoid adding dependencies.
...
* [rememberber/WePush](https://github.com/rememberber/WePush) - 专注批量推送的小而美的工具，目前支持：模板消息-公众号、模板消息-小程序、微信客服消息、微信企业号/企业微信消息、阿里云短信、阿里大于模板短信 、腾讯云短信、云片网短信、E-Mail、HTTP请求、钉钉
...
* [INRIA/spoon](https://github.com/INRIA/spoon) - Spoon :spoon: is a library to analyze, transform, rewrite Java source code (incl Java 9, 10, 11). Made with :heart:, :beers: and :sparkles:. It parses source files to build a well-designed AST with powerful analysis and transformation API.
