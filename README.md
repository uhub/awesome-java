...
* [wuyouzhuguli/FEBS](https://github.com/wuyouzhuguli/FEBS) - Spring Boot 2.0.3 & Shiro1.4.0 权限管理系统。master分支为Oracle11g版本，mysql分支为MySQL5.7版本。预览地址：http://111.230.157.133/febs/login
...
* [watson-developer-cloud/java-sdk](https://github.com/watson-developer-cloud/java-sdk) - :burrito: Java SDK to use the IBM Watson services.
