...
* [oblac/jodd](https://github.com/oblac/jodd) - Jodd v5! Lightweight. Java. Zero dependencies. Use what you like.
...
* [a466350665/smart-sso](https://github.com/a466350665/smart-sso) - Java单点登录权限系统，权限按钮级、修改实时生效、支持分布式
...
* [INRIA/spoon](https://github.com/INRIA/spoon) - Spoon is a metaprogramming library to analyze and transform Java source code (up to Java 14). :spoon: is made with :heart:, :beers: and :sparkles:. It parses source files to build a well-designed AST with powerful analysis and transformation API.
