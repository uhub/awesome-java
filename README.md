...
* [google/tink](https://github.com/google/tink) - Tink provides an easy, simple, secure, agile and fast API for common cryptographic tasks.
...
* [alibaba/transmittable-thread-local](https://github.com/alibaba/transmittable-thread-local) - :octocat: The missing std Java™ lib for middleware(simple & 0-dependency), transmitting ThreadLocal value between threads even using thread pool.
...
* [watson-developer-cloud/java-sdk](https://github.com/watson-developer-cloud/java-sdk) - :gift::gift: Java SDK to use the IBM Watson services. It supports Android.
...
* [bill1012/AdminEAP](https://github.com/bill1012/AdminEAP) - An application development platform base on AdminLTE using Java http://www.admineap.com
...
* [jaxio/celerio-angular-quickstart](https://github.com/jaxio/celerio-angular-quickstart) - Generate an Angular 4.2.3 CRUD application from an existing database schema (we provide a sample one)
...
* [zalando/intellij-swagger](https://github.com/zalando/intellij-swagger) - A plugin to help you easily edit Swagger specification files inside IntelliJ IDEA
