...
* [remkop/picocli](https://github.com/remkop/picocli) - The easiest way to build cool command line apps on & off the JVM. Colors, autocompletion, subcommands, GraalVM native images...  In 1 source file so apps can include as source & avoid adding a dependency. For Java, Groovy, Kotlin, Scala,...
